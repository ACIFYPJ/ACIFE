<%@ Page Title="" Language="C#" MasterPageFile="~/AllMasterPages/PublicMasterPage.Master" AutoEventWireup="true" CodeBehind="A_Events.aspx.cs" Inherits="ACI_FrontEndWeb_Development.AllPages.E.Events.A_Events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        function openEvent(id) {
            popupWin = window.location = 'B_EventDetailed.aspx?EventID=' + id,
            'open_window' + id,
