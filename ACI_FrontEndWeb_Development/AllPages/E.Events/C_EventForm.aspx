...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        ...
        <fieldset class="form-horizontal">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="NRIC">NRIC/FIN:</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="Name">Date Of Birth</label>
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="HighestEducation">Highest Education</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="CurrentEmployment">Current Employment</label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                ...
                <label class="control-label col-sm-3" for="ReferralSource">Where do you get to know us?</label>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="ReferralSource"></label>
                <div class="col-sm-2">
                ...
                <div class="col-sm-2">
                    <asp:CheckBox ID="chkOthers" CssClass="form-check-input" ValidationGroup="ReferralSource" Text="Other" runat="server" OnCheckedChanged="chkOthers_CheckedChanged" AutoPostBack="True" />
                </div>
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <asp:Label ID="lblOthers" Visible="false" class="control-label col-sm-3" runat="server" Text="Others:"></asp:Label>
                <div class="col-sm-7">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="SignUpReason">Reason for signing up? (Optional) </label>
                <div class="col-sm-7">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close</button>
                           <a href="../../HomePage.aspx"> <button type="button" class="btn btn-success">
                                Home</button></a>
                        </div>
                    </div>
                    <!-- /.modal-content -->
