<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoursesForm3.aspx.cs" Inherits="ACI_FrontEndWeb_Development.AllPages.H.OnlineSignUpForm.CoursesForm3" %>
                ...
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="text-center">Registration Step 3 of 5</h2>
                            ...
                            <div class="col-sm-12">
                                <fieldset class="form">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:DropDownList ID="ddlICFirstLetter" runat="server" CssClass="form-control">
                                        ...
                                        <div class="col-lg-8">
                                            <asp:TextBox ID="tbIdentification" Style="clear: both;" CssClass="form-control" placeholder="NRIC No / FIN No / Passport No" runat="server" TextMode="Number"></asp:TextBox>
                                        </div>

                                        <div class="col-lg-2">
                                            <asp:DropDownList ID="ddlICLastLetter" runat="server" CssClass="form-control">
                                        ...
                                        <div class="col-lg-12">
                                            <asp:RequiredFieldValidator ID="rvIdentificationNo" runat="server" Display="Dynamic" CssClass="alert-danger" ControlToValidate="tbIdentification" ErrorMessage="Please fill in the Identification No." ValidationGroup="SignUpEventForm"></asp:RequiredFieldValidator>

                                            <asp:CustomValidator ID="cvIdentificationNo" runat="server" ControlToValidate="tbIdentification" Display="Dynamic" CssClass="alert-danger"
                                                ErrorMessage="Please enter a valid Identification No." OnServerValidate="cvIdentificationNo_ServerValidate" ValidateEmptyText="false" ValidationGroup="SignUpEventForm"></asp:CustomValidator>
                                            <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator1" runat="server"
                                                ValidationGroup="SignUpEventForm" ErrorMessage="Please enter your identification number correctly" ControlToValidate="tbIdentification" ValidationExpression="^[0-9]{7,25}$" CssClass="alert-danger"></asp:RegularExpressionValidator>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <asp:DropDownList ID="ddlRaceValue" CssClass="form-control" runat="server">
                                        ...
                                        <asp:ListItem Value="E">Eurasian</asp:ListItem>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 text-right">
                                                <asp:Button ID="BtnNext" CssClass="btn btn-success" runat="server" ValidationGroup="SignUpEventForm" Text="Next" OnClick="BtnNext_Click" />
                                            </div>
                                        </div>
                                    </div>
